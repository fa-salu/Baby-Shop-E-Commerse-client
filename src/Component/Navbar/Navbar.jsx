...
//   const {total, login, search, setSearch, filteredProducts} = useContext(ShopContext)
...
//         <div key={product.id} className="border border-gray-200 rounded-md overflow-hidden shadow-md">
...
//               <button className="bg-blue-500 hover:bg-blue-600 text-white py-1 px-3 rounded-md focus:outline-none">Add to Cart</button>
//             </div>
//           </div>
//         </div>
//       )))}
