  ...
  return (
    <div className="py-12 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-semibold text-gray-700 uppercase text-center mb-4">
          NEW ARRIVALS
        </h1>
        <p className="text-bold text-gray-800 text-center mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {New_Arrivals.map((item) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h4 className="text-lg font-semibold mb-1 text-gray-900">{item.name}</h4>
